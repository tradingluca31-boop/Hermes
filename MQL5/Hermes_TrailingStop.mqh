...
void UpdateTrailingStop() {
    ...
    //==================================================================
    // PALIER 7: +3.5R - Sécurise +3.0R (75% MAX SÉCURITÉ) 🔒
    //==================================================================
    else if(r_current >= 3.5 && g_CurrentPosition.current_trailing_level < 7) {
        if(g_CurrentPosition.direction == 1) {
            new_sl = g_CurrentPosition.entry_price +
                     (3.0 * g_CurrentPosition.initial_risk_pips);
        }
        else {
            new_sl = g_CurrentPosition.entry_price -
                     (3.0 * g_CurrentPosition.initial_risk_pips);
        ...
        Print("🔒 TRAILING +3.5R: +3.0R LOCKED (75% MAX SECURITY)");
        Print("   Trailing now follows with +0.5R offset...");
    }

    //==================================================================
    // APRÈS +3.5R: TRAILING CONTINU (offset constant +0.5R)
    //==================================================================
    else if(r_current > 3.5 && g_CurrentPosition.current_trailing_level == 7) {
